class Solution 
{
    public int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) 
    {
        ...
        // areaOfOverlap is counted twice when in the summation of areaOfA and areaOfB, so we need to subtract it from the total, to get the toal area covered by both the rectangles
